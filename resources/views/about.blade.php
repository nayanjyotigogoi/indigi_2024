    ...
    <div class="why-choose-us-container">
        ...
        <div class="why-choose-us-cards-container">
            <div class="why-choose-us-card">
                <img src="{{ asset('/svg/count/industry_Verticals.svg') }}" alt="Experience Icon" class="why-choose-us-icon">
                <h2>Expertise & Experience</h2>
                <p>We have years of experience delivering innovative solutions across diverse industries.</p>
            </div>
            <div class="why-choose-us-card">
                <img src="{{ asset('/svg/count/happy_clients.svg') }}" alt="Innovation Icon" class="why-choose-us-icon">
                <h2>Innovation-Driven</h2>
                <p>We use cutting-edge technologies to drive innovation and meet your business needs.</p>
            </div>
            <div class="why-choose-us-card">
                <img src="{{asset('/svg/count/Completed_projects.svg')}}" alt="Support Icon" class="why-choose-us-icon">
                <h2>24/7 Support</h2>
                <p>We provide round-the-clock support to ensure the smooth running of your operations.</p>
            </div>
        </div>
    </div>
        ...
        <div class="contact-content">
            <div class="contact-left">
                <div class="Contactmap-container">
                    <iframe width="100%" height="250px" style="border-radius: 8px; border: 0;" loading="lazy" allowfullscreen referrerpolicy="no-referrer-when-downgrade" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14316.673843579536!2d91.79659537327568!3d26.126282165576393!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x375a599292a5c5df%3A0xc7e4b99f5a7d6f2d!2sPanjabari%20Rd%2C%20Guwahati%2C%20Assam%20781037!5e0!3m2!1sen!2sin!4v1707903154621!5m2!1sen!2sin"></iframe>
                </div>
